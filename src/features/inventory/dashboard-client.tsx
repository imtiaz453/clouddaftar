...
function StatCard({
  ...
  return (
    <Card
      className={href ? "cursor-pointer transition-all hover:shadow-md" : ""}
      onClick={() => {
    ...
    return (
      <div className="flex h-[50vh] items-center justify-center p-4">
        <EmptyState
          ...
          description="There was an error loading inventory data."
        />
      </div>
    );
  }
  ...
  const statCards = [
    {
      ...
      sub: `${data.totalSkuWithStock || 0} with stock`,
    ...
    },
    {
      icon: DollarSign,
      label: "Damaged Stock",
      value: `$${(data.damagedStockValue || 0).toLocaleString()}`,
      color: "text-red-600",
    },
    {
      icon: UserCircle,
      label: "Employee Custody",
      value: `$${(data.employeeCustodyValue || 0).toLocaleString()}`,
      color: "text-blue-600",
    },
  ];
          ...
          <CardContent>
            {data.stockByLocation?.length > 0 ? (
              ...
              <EmptyState
                ...
                description="Create a location to start tracking stock."
              />
            )}
          </CardContent>
        </Card>
          ...
          <CardContent>
            {data.recentMovements?.length > 0 ? (
                ...
                {data.recentMovements.slice(0, 8).map((m: any) => (
                  ...
                  >
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-xs text-muted-foreground">
                        {m.locationName} · {formatDateTime(m.createdAt)}
                      </p>
                    </div>
              ...
              <EmptyState
                ...
                description="Movements appear when stock changes."
              />
            )}
          </CardContent>
        </Card>
