...
export function CustomerStatementClient({ customers }: CustomerStatementClientProps) {
  ...
  return (
    <div className="cd-page">
      <PageHeader title="Customer Statement" description="Review opening balance, transaction movements, and closing balance in a clean responsive statement view">
        ...
        <CardContent className="p-0">
          <div className="cd-form-grid">
            ...
            <div className="flex items-end">
              <Button className="w-full" onClick={generateStatement} disabled={!customerId || loading}>
      ...
      {!data && !error && (
        <div className="cd-empty-hint">
          Select a customer, choose an optional date range, then generate the statement.
        </div>
      )}
          ...
          <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
            <div className="cd-stat-card">
              <div className="flex items-start justify-between gap-3">
                <div>
                  <p className="cd-stat-label">Customer</p>
                  <p className="mt-1 truncate text-lg font-semibold">{data.customer.name}</p>
                  {data.customer.phone && <p className="mt-1 text-xs text-muted-foreground">{data.customer.phone}</p>}
                </div>
